...
import ToolSelector from "@/components/tool/ToolSelector.tsx";
...
function ToolAssignmentManager({ characterId }: ToolAssignmentManagerProps) {
    ...
    const handleToolToAssignSelect = (
    ...
    const isLoading =
        assignedToolsQuery.isLoading || availableToolsQuery.isLoading;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg shadow space-y-4">
                ...
                <Button
                    ...
                    isLoading={
                        isProcessing &&
                        assignmentMutation.variables?.action === "assign"
                    }
                        ...
                        {(assignedToolsQuery.data || []).map((tool) => (
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    isLoading={
                                        isProcessing &&
                                        assignmentMutation.variables?.toolId ===
                                            tool.id &&
                                        assignmentMutation.variables?.action ===
                                            "unassign"
                                    }
                                    loadingText="..."
