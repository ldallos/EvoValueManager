        ...
        reader.onload = (readerEvent) => {
            ...
            img.onload = () => {
                ...
                if (ctx) {
                    ...
                    canvas.toBlob(
                        (blob) => {
                            if (blob) {
                                ...
                                toast.error(t("toast.resizeFailed"));
                                setSelectedFile(null);
                                setPreview(null);
                            }
                        },
                    ...
                    toast.error(t("toast.canvasContextFailed"));
                    setSelectedFile(null);
                    setPreview(null);
                }
            };
        ...
        <div className="flex flex-col items-center gap-4">
            <div className="relative w-32 h-32">
                <img
                    ...
                    src={
                        preview ||
                        (character.hasAvatar && !imageError
                            ? avatarSrc
                            : undefined)
                    }
                    alt={character.name}
            ...
            <div className="flex gap-2">
                ...
                >
                    ...
                    {isTooltipVisible && (
                        <div className="absolute z-10 bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 bg-slate-700 text-white text-xs rounded-lg shadow-lg whitespace-nowrap opacity-0 animate-fade-in-up">
                            {t("avatar.tooltipMaxSize")}: {MAX_DIMENSION}x
                            {MAX_DIMENSION}px,{" "}
                ...
                {preview && selectedFile && (
                    <Button
                        ...
                        loadingText={t("avatar.uploadingButton")}
                    >
                        {t("avatar.saveButton")}
                    </Button>
                )}
